...
class ViewController: UIViewController {
    ...
    var phoneNumber = ""
    var fcmToken: String?
    var privaciesPolicy = false
    
    /***
        let state = kapidaNakitSwitch.isOn
     */
    
    @IBOutlet weak var privacyPolicies: UISwitch!
    @IBOutlet weak var otpTextField: UITextField!
    @IBOutlet var keyboardHeightLayoutConstraint: NSLayoutConstraint?
    @IBOutlet weak var phoneNumberTextField: UITextField!
    @IBOutlet weak var infoLabel: UILabel!
    @IBOutlet weak var sozlesme: UIStackView!
    
    @IBAction func privacyPolicies(_ sender: Any) {
        let state = privacyPolicies.isOn
        if state {
            privaciesPolicy = true
        } else {
            privaciesPolicy = false
        }
    }
